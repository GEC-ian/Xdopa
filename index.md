...
<b:if cond='data:view.isLayoutMode'>
  <b:template-skin><![CDATA[
    .navbar .navbar-collapse, section.banner, .about, .skills, .services, .counter-area, .portfolio, .timeline, .testimonials, .contact .col-lg-4 {
      display: none;
    }
]]></b:template-skin>
</b:if>
  ...
  <b:if cond='data:blog.pageType != &quot;item&quot;'>
    <b:if cond='data:blog.pageType != &quot;static_page&quot;'>
      <style>
        ...
        .post-slide .post-img img, .post-slide:hover .post-img img{
          height: 240px;
        }
        .post-slide .post-title {
          height: 50px;
  ...
  <script type='text/javascript'>//&lt;![CDATA[
    ...
    var no_thumb = &#39;https://2.bp.blogspot.com/-P-GUNABxRKw/WC1q72iQ7PI/AAAAAAAAA7g/ByI_TtOtf_E4yMqd6z2NyoHAcBEk3y9EQCLcB/s1600/default%2Bimage.JPG&#39;;
...
<script>
  ...
  OneSignal.push(function() {
    ...
    OneSignal.init({
      ...
      appId: &quot;3295bec5-79d2-4c84-8bf5-8912623fab51&quot;,
  ...
  <script async='async' crossorigin='anonymous' src='https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-5543332361953362'/>--&gt;
<!--<body>-->
<body>
  ...
  <nav class='navbar navbar-expand-lg navbar-dark'>
    <div class='container'>
      <b:section class='header' id='header' maxwidgets='1' showaddelement='yes'>
        <b:widget id='Header1' locked='true' title='PondyX (Header)' type='Header' version='1'>
          <b:widget-settings>
...
<b:include name='title'/>
              ...
              <div id='header-inner'>
                <b:if cond='data:blog.url == data:blog.homepageUrl'>
                  ...
                  <b:else/>
                  <a class='navbar-brand logo' expr:href='data:blog.homepageUrl'>
                    <b:include name='title'/>
                  </a>
                </b:if>
                <!--<b:include name='description'/>-->
  ...
  <b:if cond='data:blog.url == data:blog.homepageUrl'>
    <!--Home Section Start-->
    <section class='banner' data-scroll-index='0' data-stellar-background-ratio='.7' id='home' style='background-image: url(&apos;https://1.bp.blogspot.com/-FSqcC_wpjcE/YRtP-7fkRQI/AAAAAAAAKC0/KKeGwUqbVAAFpkNmFfbJ_LLAlpEjh8bIACLcBGAsYHQ/s0/IMG_20210817_112449.jpg;)'>
      <div class='container'>
        <!--Banner Content-->
        <div class='banner-div'>
		<!-- Header Name -->
          <h1>HI! I&#39;M <span>GAUTAM</span></h1>
          <p class='cd-headline clip is-full-width'>
            ...
            <span class='cd-words-wrapper' style='width: 236.9px;'>
              ...
              <b class='is-hidden'>Blogger.</b>
              <b class='is-hidden'>Design.</b>
          ...
          <div class='social-icons mt-15'>
            <a href='https://www.facebook.com/ItsmeGautambhaiaEE'><i class='fab fa-facebook-f'/></a>
            <a href='https://www.linkedin.com/in/gecnawada'><i class='fab fa-linkedin-in'/></a>
                 <a href='https://mobile.twitter.com/GAUTAMK23755089'><i class='fab fa-twitter'/></a>
            <a href='https://www.instagram.com/crazy_lab_tools/'><i class='fab fa-instagram'/></a>
          </div>
        </div>
        <div class='arrow bounce'>
          <a class='fa fa-chevron-down fa-2x' data-scroll-nav='1' href='#'/>
        </div>
      </div>
    </section>
    <!--Home Section End-->
      ...
      <div class='container'>
        <div class='row'>
          <div class='col-lg-7 col-md-6'>
            ...
            <div class='about-div'>
              <div class='about-title'>
                ...
                <h4> Blogger Frontend And Backend Developer.</h4>
              </div>
              <p>Me <b>Gautam</b>I belong to Nalanda district of Bihar state and presently I am doing engineering from &quot;Aryabhatta Knowledge University Patna&quot; and I learn skills like online website designing, website development, digital marketing marketing and programming in my spare time..</p>
              ...
              <div class='table-responsive'>
                <table class='info-table'>
                  <tbody>
                    <tr>
                      <th>
                        <i class='hidden-xs far fa-calendar-alt'/>
                        <span>Brithday</span>
                      </th>
                      <td>01-03-2002</td>
                    </tr>
                    <tr>
                      <th>
                        <i class='hidden-xs fas fa-phone'/>
                        <span>Call</span>
                      </th>
                      <td>+91 7667815493</td>
                    </tr>
                    <tr>
                      <th>
                        <i class='hidden-xs  fas fa-paper-plane'/>
                        <span>Email</span>
                      </th>
                      <td>ritesh797063@gmail.com</td>
                    </tr>
                    <tr>
                      <th>
                        <i class='hidden-xs fas fa-globe'/>
                        <span>Website</span>
                      </th>
                      <td>www.pondyx.ml</td>
                    </tr>
          ...
          <div class='col-lg-5 col-md-6'>
            <!--About Image-->
            <div class='about-img'>
              <img alt='' class='img-fluid' src='https://1.bp.blogspot.com/-bbOeIAaMhsk/YRpS3Q-BylI/AAAAAAAAKCI/Ras1y1ROMcolBkva-oOtiMXxlgTbdLp-gCLcBGAsYHQ/s16000/IMG_20210723_115755.jpg'/>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class='row'>
          <div class='col-lg-6'>
            <div class='skill-div'>
              ...
              <p>I know C,Python,Java and HTML in programming language and am expert in blogger website designing and website development and tools make sketch.</p>
              <p>As A member of INTERNSHALA STUDENT PARTNER, I have developed social media marketing skills that can help in making good marketing campaigns plus I am good with numbers which helps me quickly analyse the results of any marketing campaign and tweak it further. I wish to build a career in digital marketing.</p>
            </div>
          </div>
          <div class='col-lg-6'>
            <div class='skill-div '>
    ...
    <section class='counter-area pt-100 pb-100' style='background-image: url(&apos;https://1.bp.blogspot.com/-xDh-4Tu3FiA/YRppAAyZ_9I/AAAAAAAAKCo/8fTbBY9MgCsQ9jRTHJqbvV_kOFP1uNj3ACLcBGAsYHQ/s0/pexels-photo-220067.jpeg;)'>
      <div class='container'>
        <div class='row'>
          <div class='col-lg-3 col-md-6'>
            <!--Stats Item-->
            <div class='counter-item'>
              <h2 class='counter' data-count='51'>1001</h2>
              <h5>Happy Clients</h5>
          ...
          <div class='col-lg-3 col-md-6'>
            <!--Stats Item-->
            <div class='counter-item'>
              <h2 class='counter' data-count='16'>250</h2>
              <h5>Projects Done</h5>
            </div>
          </div>
          <div class='col-lg-3 col-md-6'>
            <!--Stats Item-->
            <div class='counter-item'>
              <h2 class='counter' data-count='0'>150</h2>
              <h5>Awards Won</h5>
    ...
    <section class='portfolio bg-gray pt-100 pb-100' data-scroll-index='3' id='portfolio'>
      <div class='container'>
          ...
          <div class='col'>
            ...
            <div class='port-filter text-center'>
              <ul>
                ...
                <li data-filter='.Photograph'>Photograph</li>
        ...
        <script type='text/javaScript'>
          document.write(&quot;&lt;script src=\&quot;/feeds/posts/default?max-results=&quot;+portfolio_numposts+&quot;&amp;orderby=published&amp;alt=json-in-script&amp;callback=portfolioposts\&quot;&gt;&lt;\/script&gt;&quot;);
        </script>
      </div>
    </section>
          ...
          <div class='main-timeline'>
            <div class='timeline'>
              ...
              <div class='timeline-content'>
                ...
                <h5 class='title'>Electrical Engineer</h5>
                <p class='description'>
                  I am doing electrical engineering from government engineering college nawada i had dream of becoming electrical engineer which seems to be fulfilled.
                </p>
              </div>
            </div>
            ...
            <div class='timeline'>
              <div class='timeline-icon'/>
              <div class='timeline-content'>
                <span class='date'>Mar 2018 - Present</span>
                <h5 class='title'>Blogger Website Designing</h5>
                <p class='description'>
                  I enjoy designing and developing websites and doing any digital work like digital marketing.
                </p>
              </div>
            </div>
            ...
            <div class='timeline'>
              ...
              <div class='timeline-content'>
                ...
                <h5 class='title'>C Programer</h5>
                <p class='description'>
                  I am interested in learning programming and doing programming. I had no idea of programming before taking admission in engineering But now I enjoy programming.
                </p>
              </div>
            </div>
          </div>
    ...
    <section class='testimonials counter-area pt-100 pb-100' style='background-image: url(&apos;https://lh3.googleusercontent.com/-z44-7KzCHYM/XQt7nr1Nb6I/AAAAAAAAAOs/UPbxV3Qjgh4vB6ON7hWt573nBqPZ9BpKQCLcBGAs/s1600/pexels-photo-220067.jpeg&apos;)'>
      <div class='container'>
        <div class='row'>
...
building progress by weight.
                ...
                <div class='testimonial-review'>
                  <div class='pic'>
                    <img alt='' src='https://1.bp.blogspot.com/-ncrDC1EUhJY/YRpN3iy9HrI/AAAAAAAAKB4/3LbL3cDO2nQvBKR0SnR236HbIwIxenGgACLcBGAsYHQ/s1479/IMG_20210816_170437.jpg'/>
                  </div>
              ...
              <div class='testimonial'>
                ...
                <div class='testimonial-review'>
                  <div class='pic'>
                    <img alt='' src='https://1.bp.blogspot.com/-b7JO1b-tde4/YRpOFut3ZBI/AAAAAAAAKB8/SMCJsS8gEUgdwPOQP9W4cqS3O04xwdo7QCLcBGAsYHQ/s1070/IMG_20210816_170302.jpg'/>
                  </div>
                  <h4 class='testimonial-title'>
                    Ritesh Kumar
...
building progress by weight.
  ...
  <b:if cond='data:blog.url != data:blog.homepageUrl'>
    <section class='page-title' data-stellar-background-ratio='.7' style='background-image: url(&apos;https://1.bp.blogspot.com/-bbOeIAaMhsk/YRpS3Q-BylI/AAAAAAAAKCI/Ras1y1ROMcolBkva-oOtiMXxlgTbdLp-gCLcBGAsYHQ/s16000/IMG_20210723_115755.jpg;);'>
      <div class='container'>
        <!--Banner Content-->
  ...
  <b:if cond='data:blog.url == data:blog.homepageUrl'>
    ...
    <section class='blog pt-100 pb-100' data-scroll-index='4' id='blog'>
      <div class='container'>
        ...
        <b:section class='content' id='content1' showaddelement='no'>
          <b:widget id='Blog1' locked='true' title='Blog Posts' type='Blog' version='1'>
            ...
            <b:includable id='post' var='post'>
              ...
              <div class='post-slide' expr:id='&quot;p&quot; + data:post.id'><data:post.body/></div>
              <script type='text/javascript'>var x=&quot;<data:post.title/>&quot;,y=&quot;<data:post.url/>&quot;,z=&quot;<data:post.author/>&quot;,t=&quot;<data:post.timestamp/>&quot;;readmore(&quot;p<data:post.id/>&quot;,&quot;<data:post.author/>&quot;,&quot;<data:post.timestamp/>&quot;,&quot;<data:post.numComments/>&quot;,&quot;<data:post.snippet/>&quot;)</script>
    ...
    <b:if cond='data:blog.searchLabel'>
      ...
      <!--Search Label Blog Section Start-->
      <section class='blog pt-100 pb-100' data-scroll-index='4' id='blog'>
        <div class='container'>
          <div class='row'>
            <div class='col text-center'>
          ...
          <b:section class='content' id='content2' showaddelement='no'>
...
<b:include data='top' name='status-message'/>
      ...
      <!--Search Label Blog Section End-->

      <b:else/>

      <b:if cond='data:blog.searchQuery'>

        <!--Search Query Blog Section Start-->
        <section class='blog pt-100 pb-100' data-scroll-index='4' id='blog'>
          <div class='container'>
            <div class='row'>
              <div class='col text-center'>
            ...
            <b:section class='content' id='content3' showaddelement='no'>
              <b:widget id='Blog3' locked='true' title='Blog Posts' type='Blog' version='1'>
                <b:widget-settings>
                  <b:widget-setting name='showDateHeader'>true</b:widget-setting>
                  <b:widget-setting name='style.textcolor'>#000000</b:widget-setting>
                  <b:widget-setting name='showShareButtons'>true</b:widget-setting>
...
<b:include data='top' name='status-message'/>
        ...
        <b:if cond='data:blog.pageType == &quot;error_page&quot;'>
          ...
          <section class='error pt-100 pb-100' id='404'>
            <div class='container'>
              <div class='row'>
                <div class='col text-center'>
                  <div class='main-title'>
          ...
          <b:if cond='data:blog.pageType == &quot;item&quot;'>
            ...
            <section class='pt-100 pb-100 blog-details-post' data-scroll-index='4' id='blog'>
              <div class='container'>
                <div class='row'>
                  <div class='col-md-9'>
                    <b:section class='content' id='content4' showaddelement='no'>
                      <b:widget id='Blog4' locked='true' title='Blog Posts' type='Blog' version='1'>
                        <b:widget-settings>
                          <b:widget-setting name='showDateHeader'>true</b:widget-setting>
                          <b:widget-setting name='style.textcolor'>#000000</b:widget-setting>
                          <b:widget-setting name='showShareButtons'>true</b:widget-setting>
                          ...
                          <b:if cond='data:blog.pageType == &quot;item&quot;'>
                            <div class='post-content'>
                              <div class='blog-details-img'>
                                <!--== Blog image ==-->
                                <a class='blog-image' expr:href='data:post.url'>
                                  <img expr:alt='data:post.title' src=''/>
                                </a>
                                <div class='entry-header'>
                                  <div class='entry-meta'>
                                    <ul>
                                      <li><i class='fa fa-user'/> Post by: <a><data:post.author/></a></li>
                                      <li><i class='fas fa-comments'/> <a><data:post.numComments/> Comments</a></li>
                                      <li><i class='fa fa-clock'/> <a><data:post.timestamp/></a></li>
                                    </ul>
                                  </div>
                              ...
                              <div class='entry-body'>
                                <span class='data-post-body'><data:post.body/></span>
                              </div>
                    ...
                    <div class='blog-sidebar'>
                      <b:section class='sidebar' id='sidebar' showaddelement='yes'>
                        ...
                        <b:widget id='PopularPosts1' locked='false' title='Popular Posts' type='PopularPosts' version='1'>
                          ...
                          <b:includable id='main'>
                            <b:if cond='data:title'><h3>Popular Posts</h3></b:if>
                        ...
                        <b:widget id='PageList2' locked='false' title='Login' type='PageList' visible='true'>
                          <b:widget-settings>
  ...
  <ul>
    ...
    <b:loop values='data:links' var='link'>
      <b:include name='pageLink'/>
                    ...
                    &lt;div class=&quot;fb-page&quot; data-href=&quot;https://www.facebook.com/ItsmeGautambhaiaEE/&quot; data-small-header=&quot;false&quot; data-adapt-container-width=&quot;true&quot; data-hide-cover=&quot;false&quot; data-show-facepile=&quot;true&quot;&gt;&lt;blockquote cite=&quot;https://www.facebook.com/ItsmeGautambhaiaEE/&quot; class=&quot;fb-xfbml-parse-ignore&quot;&gt;&lt;a href=&quot;https://www.facebook.com/ItsmeGautambhaiaEE/&quot;&gt;&lt;itsmegautambhaiaee/a&gt;&lt;/itsmegautambhaiaee&gt;&lt;/a&gt;&lt;/blockquote&gt;&lt;/div&gt;</b:widget-setting>
                          </b:widget-settings>
                          <b:includable id='main'>
            ...
            <b:if cond='data:blog.pageType == &quot;static_page&quot;'>
              ...
              <section class='pt-100 pb-100 blog-details-post' data-scroll-index='4' id='blog'>
                <div class='container'>
                  <div class='row'>
                    <div class='col-md-9'>
                      <b:section class='content' id='content5' showaddelement='no'>
                        <b:widget id='Blog5' locked='true' title='Blog Posts' type='Blog' version='1'>
                          <b:widget-settings>
                            <b:widget-setting name='showDateHeader'>true</b:widget-setting>
                            <b:widget-setting name='style.textcolor'>#000000</b:widget-setting>
                            <b:widget-setting name='showShareButtons'>true</b:widget-setting>
                    ...
                    <div class='col-md-3'>
                      <div class='blog-sidebar'>
                        <b:section class='sidebar' id='sidebar2' showaddelement='yes'>
                          <b:widget id='Label12' locked='false' title='Labels' type='Label' version='1'>
                            <b:widget-settings>
                              <b:widget-setting name='sorting'>ALPHA</b:widget-setting>
                              <b:widget-setting name='display'>LIST</b:widget-setting>
                              <b:widget-setting name='selectedLabelsList'/>
                          ...
                          <b:widget id='PopularPosts12' locked='false' title='Popular Posts' type='PopularPosts' version='1'>
                            <b:widget-settings>
                              <b:widget-setting name='numItemsToShow'>3</b:widget-setting>
                              <b:widget-setting name='showThumbnails'>true</b:widget-setting>
                              <b:widget-setting name='showSnippets'>false</b:widget-setting>
                          ...
                          <b:widget id='Label22' locked='false' title='categories' type='Label' version='1'>
                            <b:widget-settings>
                              <b:widget-setting name='sorting'>ALPHA</b:widget-setting>
                              <b:widget-setting name='display'>CLOUD</b:widget-setting>
                              <b:widget-setting name='selectedLabelsList'/>
              ...
              <section class='blog pt-100 pb-100' data-scroll-index='4' id='blog'>
                <div class='container'>
                  ...
                  <b:section class='content' id='content6' showaddelement='no'>
                    <b:widget id='Blog6' locked='true' title='Blog Posts' type='Blog' version='1'>
                      <b:widget-settings>
                        <b:widget-setting name='showDateHeader'>true</b:widget-setting>
                        <b:widget-setting name='style.textcolor'>#000000</b:widget-setting>
                        <b:widget-setting name='showShareButtons'>true</b:widget-setting>
                              ...
                              <div class='post hentry uncustomized-post-template' itemscope='itemscope' itemtype='http://schema.org/BlogPosting'>
                                ...
                                <div class='post-body entry-content' expr:id='&quot;post-body-&quot; + data:post.id' itemprop='articleBody'>
                                  ...
                                  <div id='share-buttons-mobile'>
                                    ...
                                    <a expr:href='&quot;https://www.facebook.com/ItsmeGautambhaiaEE; + data:blog.url' rel='nofollow' style='background:#3b5998;'>
                                      Facebook
                                    </a>
                                    <a expr:href='&quot;http://plus.google.com/share?url=&quot; + data:blog.url' rel='nofollow' style='background:#c0361a;'>
                                      Google+
                                    </a>
                                    <a expr:href='&quot;; + data:blog.url + &quot;&amp;text=&quot;https://mobile.twitter.com/GAUTAMK23755089; + data:post.title + &quot;&amp;lang=id&quot;' rel='nofollow' style='background:#4099ff;'>
                                      Twitter
                                    </a>
                                    <div class='clear'/>
                                  </div>
  ...
  <section class='contact pt-100 pb-100' data-scroll-index='5'>
	...
	SGPMPopupLoader.call(window,document,&#39;script&#39;,&#39;https://popupmaker.com/assets/lib/SGPMPopup.min.js&#39;,&#39;15d9f6c9723a&#39;);
  ...
  <div class='widget-content'>
    <data:content/>
            ...
            <b:widget id='HTML2' locked='false' title='' type='HTML' visible='true'>
              <b:widget-settings>
                <b:widget-setting name='content'>&lt;!-- Chatra {literal} --&gt;
&lt;script&gt;
    (function(d, w, c) {
        w.ChatraID = &#39;t3Nzub5egr5GMsuAv&#39;;
...
&lt;/script&gt;
&lt;!-- /Chatra {/literal} --&gt;</b:widget-setting>
              </b:widget-settings>
              <b:includable id='main'>
  <b:include name='widget-title'/>
  <div class='widget-content'>
    <data:content/>
            ...
            <b:widget id='HTML3' locked='false' title='' type='HTML' visible='true'>
              <b:widget-settings>
                <b:widget-setting name='content'>&lt;div id=&quot;whatswidget-pre-wrapper&quot; class=&quot;&quot;&gt;
...
&lt;div id=&quot;whatswidget-conversation-title&quot; class=&quot;whatswidget-conversation-title&quot; style=&quot;all:revert;&quot;&gt;Gautam Kumar&lt;/div&gt;&lt;/div&gt;&lt;div id=&quot;whatswidget-conversation-message&quot; class=&quot;whatswidget-conversation-message &quot; style=&quot;all:revert;&quot;&gt;Hello, How are you?&lt;/div&gt;&lt;div class=&quot;whatswidget-conversation-cta&quot; style=&quot;all:revert;&quot;&gt; &lt;a style=&quot;all:revert;&quot; id=&quot;whatswidget-phone-desktop&quot; target=&quot;_blank&quot; href=&quot;https://web.whatsapp.com/send?phone=+919065474559&quot; class=&quot;whatswidget-cta whatswidget-cta-desktop&quot;&gt;Send message&lt;/a&gt; &lt;a id=&quot;whatswidget-phone-mobile&quot; target=&quot;_blank&quot; href=&quot;https://wa.me/+919065474559&quot; class=&quot;whatswidget-cta whatswidget-cta-mobile&quot; style=&quot;all:revert;&quot;&gt;Send message&lt;/a&gt;
...
&lt;div id=&quot;whatswidget-conversation-message-outer&quot; class=&quot;whatswidget-conversation-message-outer&quot; style=&quot;all:revert;&quot;&gt; &lt;span id=&quot;whatswidget-text-header-outer&quot; class=&quot;whatswidget-text-header-outer&quot; style=&quot;all:revert;&quot;&gt;PondyX&lt;/span&gt;&lt;br /&gt; &lt;div id=&quot;whatswidget-text-message-outer&quot; class=&quot;whatswidget-text-message-outer&quot; style=&quot;all:revert;&quot;&gt;Hello, How are you?&lt;/div&gt;&lt;/div&gt;&lt;div class=&quot;whatswidget-button-wrapper&quot; style=&quot;all:revert;&quot;&gt;&lt;div class=&quot;whatswidget-button&quot; id=&quot;whatswidget-button&quot; style=&quot;all:revert;&quot;&gt;&lt;div style=&quot;margin:0 auto;width:38.5px;all:revert;&quot;&gt; &lt;img class=&quot;whatswidget-icon&quot; style=&quot;all:revert;&quot; src=&quot; https://www.oflox.com/blog/wp-content/uploads/2021/01/wpwhite.png&quot; /&gt;&lt;/div&gt;&lt;/div&gt;&lt;/div&gt;
...
&lt;/div&gt;</b:widget-setting>
  ...
  <div class='widget-content'>
    <data:content/>
            ...
            <b:widget cond='!data:view.isPost' id='PageList1' locked='false' title='' type='PageList' visible='true'>
              <b:widget-settings>
                <b:widget-setting name='pageListJson'><![CDATA[{'4706732940666330492': {'href': 'https://www.pondyx.ml/p/login_19.html', 'title': 'LOGIN', 'position': 0}, '4585322197587948689': {'href': 'https://www.pondyx.ml/p/social-awareness.html', 'title': 'Social Awareness', 'position': 1}, 'link0': {'href': 'https://s3.amazonaws.com/gonativeio/static/61332a0b37488e6a23d14970/app-release.apk', 'title': 'Download PondyX Android app', 'position': 2}, '6433552544211841501': {'href': 'https://www.pondyx.ml/p/registration.html', 'title': 'Registration', 'position': 3}}]]></b:widget-setting>
                <b:widget-setting name='homeTitle'>Home</b:widget-setting>
              </b:widget-settings>
              <b:includable id='main'>
  <b:include name='widget-title'/>
        ...
        <div class='col-lg-4'>
          <div class='contact-info'>
            ...
            <div class='contact-info-item'>
              <ul>
                <li><i class='fas fa-map-marker-alt'/> Patna, Bihar, India</li>
                <li><i class='fas fa-phone'/>+91 9065474559</li>
                <li><i class='fas fa-paper-plane'/> gautamkumar201002@gmail.com</li>
                <li><i class='fas fa-globe'/> www.pondyx.ml</li>
              </ul>
            </div>
            <div class='social-icons mt-15'>
              <a href='https://www.facebook.com/ItsmeGautambhaiaEE'><i class='fab fa-facebook-f'/></a>
  ...
  <footer class='pt-30 pb-30'>
    <div class='container'>
      <div class='row text-center'>
        <div class='col-md-12'>
          Copyright <a href='https://www.pondyx.ml/' rel='dofollow' style='color:#ffeb3b;' target='_blank' title='PondyX'>PondyX</a> All Rights Reserved
          </div>
          <div style='font-size:1px; opacity:0;'> Design By <a href='https://www.templateclue.com/' id='templateclue' ref='dofollow' title='Premium Blogger Templates'>Premium Blogger Templates</a>
